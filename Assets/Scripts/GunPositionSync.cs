...
public class GunPositionSync : NetworkBehaviour
{
    ...
    void Start()
    {
        ...
        if (isLocalPlayer)
            ...
            // record the difference in position from player and hand mount
